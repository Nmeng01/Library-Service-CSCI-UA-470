...
- It is easiest to run the app through the terminal. Make sure that your current path is in the src folder of this project. Then, run these two commands: javac Main.java  -d ../bin | java -classpath ../bin Main
